...
class ApiError extends Error {
    constructor(message, code, id, error) {
        super(message);
        ...
        this.fetch = async (method, url, options) => {
            ...
            return client
                ...
                if (_.response && _.response.data) {
                    throw new ApiError((_b = (_a = _.response.data.details) !== null && _a !== void 0 ? _a : _.response.data.timeout) !== null && _b !== void 0 ? _b : JSON.stringify(_.response.data), _.response.status, _.response.data.type, _);
                }
                throw new ApiError(`Something not caught went wrong`, 500, undefined, _);
            }));
        };
