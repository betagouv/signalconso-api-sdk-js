...
ReportDraft.toApi = (draft) => {
    ...
    return {
        ...draft,
        subcategories: ts_utils_1.map(draft.subcategories, subcategories => subcategories.map(_ => { var _a; return (_a = _.title) !== null && _a !== void 0 ? _a : _; })),
        ...
        fileIds: (_a = draft.uploadedFiles) === null || _a === void 0 ? void 0 : _a.map(file => file.id),
