...
const reportFilter2QueryString = (report) => {
    try {
        ...
        const parseDate = (_) => (report[_] ? { [_]: (0, __1.dateToApi)(report[_]) } : {});
        return {
            ...r,
    ...
    constructor(client) {
        ...
        this.extract = (filters) => {
            return this.client.post(`reports/extract`, {
                qs: (0, rxjs_1.pipe)(exports.cleanReportFilter, exports.reportFilter2QueryString, __1.paginateFilters2QueryString, __1.cleanObject)(filters),
            });
        };
        this.search = (filters) => {
            return this.client
                .get(`/reports`, {
                qs: (0, rxjs_1.pipe)(exports.cleanReportFilter, exports.reportFilter2QueryString, __1.cleanObject)(filters),
            })
                .then(result => {
        ...
        this.download = (id) => {
            ...
            return this.client.getPdf(`/reports/${id}/download`).then((0, __1.directDownloadBlob)('test.pdf'));
        };
        this.remove = (id) => {
        ...
        this.getCountByDepartments = ({ start, end } = {}) => {
            return this.client.get(`/reports/count-by-departments`, { qs: { start: (0, __1.dateToApi)(start), end: (0, __1.dateToApi)(end) } });
        };
    }
}
