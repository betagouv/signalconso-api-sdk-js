...
const hostReportFilter2QueryString = (hostReport) => {
    try {
        ...
        const parseDate = (_) => hostReport[_] ? { [_]: __1.dateToApi(hostReport[_]) } : {};
        return {
            ...r,
            q: q,
            ...parseDate('start'),
    ...
    constructor(client) {
        ...
        this.listUnregistered = (filters) => {
            return this.client
                ...
                .then(Paginate_1.paginateData(filters.limit, filters.offset));
        };
        ...
        this.update = (id, website) => {
            return this.client.put(`/websites/${id}`, { body: website });
        };
