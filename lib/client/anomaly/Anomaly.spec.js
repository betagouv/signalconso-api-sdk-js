...
const AnomalyClient_1 = require("./AnomalyClient");
const testParsing = (initial, expected) => {
    // @ts-ignore
    (0, chai_1.expect)(JSON.parse(JSON.stringify(initial.map(AnomalyClient_1.AnomalyClient.enrichAnomaly)))).deep.eq(expected);
};
...
//# sourceMappingURL=Anomaly.spec.js.map