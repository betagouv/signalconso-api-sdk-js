...
class AnomalyClient {
    constructor(client) {
        this.client = client;
        this.getAnomalies = (0, common_1.lazy)(() => Promise.resolve(anomalies_json_1.default.list));
        this.getCategories = (0, common_1.lazy)(() => Promise.resolve(this.getAnomalies().then(_ => _.filter(anomaly => !anomaly.information).map(anomaly => anomaly.category))));
    }
}
...
AnomalyClient.instanceOfSubcategoryInput = (_) => {
    return !!(_ === null || _ === void 0 ? void 0 : _.detailInputs);
};
AnomalyClient.instanceOfSubcategoryInformation = (_) => {
    return !!(_ === null || _ === void 0 ? void 0 : _.information);
};
AnomalyClient.instanceOfAnomaly = (_) => {
    return !!(_ === null || _ === void 0 ? void 0 : _.category);
};
