...
class CompanyClient {
    constructor(client) {
        ...
        this.getResponseRate = (id) => {
            return this.client.get(`/companies/${id}/response-rate`);
        };
        this.saveUndeliveredDocument = (siret, returnedDate) => {
            return this.client.post(`/companies/${siret}/undelivered-document`, { body: { returnedDate: (0, __1.dateToApi)(returnedDate) } });
        };
        this.create = (company) => {
        ...
        this.downloadActivationDocument = (companyIds) => {
            return this.client
                ...
                .then((0, __1.directDownloadBlob)(`signalement_depot_${(0, date_fns_1.format)(new Date(), 'ddMMyy')}`));
        };
        this.getHosts = (id) => {
