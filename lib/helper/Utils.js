...
const dateToYYYYMMDD = (date) => (date ? (0, format_1.default)(date, 'yyyy-MM-dd') : undefined);
...
const isDefined = (value) => !(0, exports.isNotDefined)(value);
exports.isDefined = isDefined;
const cleanObject = (obj) => {
    const clone = { ...obj };
    for (let k in clone) {
        const val = clone[k];
        if ((0, exports.isNotDefined)(val) || (Array.isArray(val) && val.filter(exports.isDefined).length === 0)) {
            delete clone[k];
        }
    }
    return clone;
